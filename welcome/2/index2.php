...
<html>
    ...
    <body>
        <div id="page-wrap">
                <form action="/welcome/3/index2.php" method="POST">
                    <h1><b>San mo nais magpunta?</b></h1>
                    <input type="hidden" name="vibe" value="<?php echo $_POST['vibe'];?>">
                    <input type="radio" id="beaches" name="taste" value="beaches">
                    <label>Karagatan</label><br>
                    <input type="radio" id="mountains" name="taste" value="mountains">
                    <label>Kabundukan</label><br>
                    <input type="radio" id="tourist_spots" name="taste" value="tourist_spots">
                    <label>Pandayuhang Lugar</label><br>
